        ...
        <div className="flex flex-col justify-center items-center mb-8">
          <div className="lg:flex bg-white shadow-2xl lg:px-10 p-4  lg:h-[340px] rounded-md lg:w-[1000px] lg:mt-14 items-center">
            <div className="w-[350px] lg:w-[380px] mt-4  lg:h-[350px] h-[233.97px] flex items-center  flex-col gap-2 -mb-4">
              <img
                className="w-[320px] lg:w-[380px] lg:h-[230px]  h-[170px] "
                data-aos="zoom-in"
              ...
              <div className=" justify-evenly items-center  -mt-8 lg:-mt-12">
                <div className="lg:flex px-4  lg:justify-between lg:w-[470px] lg:gap-16 ">
                  <div className="flex flex-col gap-0  md:items-center  lg:justify-center w-[340px] text-[#596574] font-semibold">
                    <div className="flex flex-col ">
                      <div className="flex items-center gap-3  ">
                        ...
                        <p className="text-[10px] p-1">
                          {data?.fields?.Infrastructure &&
                            data?.fields?.Infrastructure?.toString()?.slice(
                              0,
                              2
                            )}
                          %
                    ...
                    <div className="flex flex-col ">
                      <div className="flex items-center gap-3  ">
                        ...
                        />
                        <p className="text-[10px] p-1">
                          {data?.fields?.Administration?.toString()?.slice(
                            0,
                            2
                          )}
                          %
                      ...
                      <div className="flex items-center gap-3  ">
                        ...
                        />
                        <p className="text-[10px] p-1">
                          {data?.fields?.Extracurricular?.toString()?.slice(
                            0,
                            2
                          )}
                          %
                  ...
                  <div className="hidden lg:flex lg:flex-col lg:pt-4 lg:gap-2  gap-4">
                    ...
                    <button
                      className="flex items-center gap-4 text-white bg-[#2F3F93] px-5 py-2 border-2 border-[#2F3F93] rounded-3xl lg:gap-3 lg:px-5 lg:py-2 lg:rounded-3xl lg:text-[15px] lg:w-[154px]"
                      onClick={() => {
                        setOpen(!open);
                        setSchoolName(data?.fields?.name);
                        setSchool(data?.fields?.slug);
                      }}
                    >
                      {" "}
                ...
                <div className="flex justify-between px-4  lg:pr-5 w-[350px]  mt-5 items-center pb-5 ">
                  ...
                  <div className="flex flex-col lg:hidden gap-3 pr-1">
                    ...
                    <button
                      className="flex gap-[8px] items-center text-[11px] w-28 py-2 rounded-3xl text-center justify-center bg-[#2F3F93] text-white "
                      onClick={() => {
                        setSchool(data?.fields?.slug);
                        setSchoolName(data?.fields?.name);
                        setOpen(!open);

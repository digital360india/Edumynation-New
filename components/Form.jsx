...
const Form = ({color}) => {
  ...
  const createEnquireForm = async (description) => {
    console.log(description);
    try {
      const res = await fetch(
        "https://www.edumynation.com/api/createEnquireForm",
        {
          method: "POST",
  ...
  return (
    <>
    <>
      <div className={` ${!color?"bg-[url('https://cdn.discordapp.com/attachments/1078905801017659432/1110793183572545566/Rectangle_11.png')]":""} h-[550px] w-full bg-cover flex items-center justify-center md:justify-start md:items-start md:pl-16`}>
